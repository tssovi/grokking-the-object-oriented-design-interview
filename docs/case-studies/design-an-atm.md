...
![ATM Class Diagram](../assets/images/atm-class-diagram.png)

*Class Diagram for ATM*

![ATM UML](../assets/images/atm-uml.svg)
...
![ATM Customer Authentication Activity Diagram](../assets/images/atm-cus-auth-activity-diagram.svg)
