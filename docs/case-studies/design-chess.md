...
![Chess Use Case Diagram](../assets/images/chess-use-case-diagram.png)
...
![Chess Class Diagram](../assets/images/chess-class-diagram.png)

*Class Diagram for Chess*

![Chess UML](../assets/images/chess-uml.svg)
...
![Chess Activity Diagram](../assets/images/chess-activity-diagram.svg)
